  ...
  useEffect(() => {
    ...
    var spriteMaterial = ShaderBuilder.generateMaterial(gl, {
      ...
      globals: {
        ...
        textureScale: { type: "uniform", unit: "float", count: 1 },
      ...
      fragSource: `
                precision highp float;
                void main(void) {
                    vec4 sampleColor = texture2D(texture, (uv * sampleRect.zw + sampleRect.xy) / textureScale / textureResolution);
